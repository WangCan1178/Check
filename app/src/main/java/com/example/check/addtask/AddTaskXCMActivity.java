...
public class AddTaskXCMActivity extends AppCompatActivity
    ...
    private int groupid;
    private String description,recognition;
    private Button but_publishXCM;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_add_task_xcm);
...
//        time = new StringBuffer();
        ...
        recognition="1"; //文字识别标为0，图片识别标为1
        description = "2";
        initView();
        initDateTime();
        but_publishXCM = (Button)findViewById(R.id.but_publishXCM);
        but_publishXCM.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(AddTaskXCMActivity.this,tvFinishDate.getText().toString(),Toast.LENGTH_SHORT).show();
                Toast.makeText(AddTaskXCMActivity.this,tvStartDate.getText().toString(),Toast.LENGTH_SHORT).show();
                        ...
                        if(result.equals("success")){
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    Toast toast1 = toast.makeSuccess(AddTaskXCMActivity.this,"创建任务成功");
                                    toast1.setGravity(Gravity.TOP,0,50);
                                    toast1.show();
                                    Intent intent = new Intent(AddTaskXCMActivity.this, createActivity.class);
                            ...
                            runOnUiThread(new Runnable() {
                                ...
                                public void run() {
                                    DynamicToast toast = new DynamicToast();
                                    Toast toast1 = toast.makeError(AddTaskXCMActivity.this, result+"创建任务失败!!!");
                                    toast1.setGravity(Gravity.TOP,0,50);
                                    toast1.show();
                                }
                            });
