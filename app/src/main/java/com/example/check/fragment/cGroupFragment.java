...
// * {@link cGroupFragment.OnFragmentInteractionListener} interface
// * to handle interaction events.
// * Use the {@link cGroupFragment#newInstance} factory method to
...
//     * @return A new instance of fragment cGroupFragment.
//     */
//    // TODO: Rename and change types and number of parameters
//    public static cGroupFragment newInstance(String param1, String param2) {
//        cGroupFragment fragment = new cGroupFragment();
...
//    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        my_name = (TextView)view.findViewById(R.id.mycgroupname);
        my_id = (TextView) view.findViewById(R.id.mycgroupid);
        my_phone = (TextView) view.findViewById(R.id.mycgroupphone);
                    ...
                    if(result.equals("success")){
                        getActivity().runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                Toast toast1 = toast.makeSuccess(getActivity(),"注销群组成功");
