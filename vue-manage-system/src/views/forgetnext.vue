<template>
    <div class="login-wrap">
        <div class="ms-login">
            ...
            <el-form :model="Psw" :rules="rules" label-width="0px" class="ms-content">
                <p style="font-size: 14px;color: #909399">请输入6-16位数字字母组合</p>
                <el-form-item prop="password">
                    <el-input v-model="Psw.password" placeholder="请输入密码" type="password">
                        <template #prepend>
                ...
                <el-form-item prop="password2">
                    <el-input v-model="Psw.password2" placeholder="请再次确认密码" type="password" :disabled="pCheck">
                        <template #prepend>
                ...
                <div class="login-btn">
                    <el-button type="primary" @click="psw()" :disabled="btn">提交</el-button>
                </div>
            </el-form>
        </div>
    </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            psw(){
                this.$axios.post(
                    "http://localhost:9000/alterpsw",
                    {
                        userid:sessionStorage.getItem("phone"),
                        password:this.Psw.password,
                    }
